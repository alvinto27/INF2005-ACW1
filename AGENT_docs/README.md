...
- [Protocol Design](PROTOCOL-DESIGN.md#protocol-design) — the current stage 6b encrypted packet, carrier-derived payload-record widths, hashing, signing, receiver bootstrap, verdicts, refusal behavior, caller-side payload-envelope design, and version 1 design history.
