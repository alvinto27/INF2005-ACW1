...
- [Orchestration Handoff](ORCHESTRATION-HANDOFF.md) — historical handoff after protocol version 2 completion: baseline, roles, working method, safeguards, and open items as recorded then. Use the reduction record for current status.
