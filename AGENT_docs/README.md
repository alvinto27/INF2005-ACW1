...
- [Orchestration Handoff](ORCHESTRATION-HANDOFF.md) — handoff snapshot written before stage 4b: reading order, environment, stage reasoning, working method, and hazards. Use the stage record for current status.
