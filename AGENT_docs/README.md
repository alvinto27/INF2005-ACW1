...
- [Location Confidentiality Plan](LOCATION-CONFIDENTIALITY-PLAN.md) — protocol version 2 design, stage 4c outcome, and Stage 5 notebook outcome. Holds the field-binding audit, the decode-order invariant, the accepted trade-offs, and the remaining staging plan.
