...
| Chunked carrier access: design, invariants, WAV backend, chunk size, memory claim, `MAX_WAV_FRAME_BYTES`, and web follow-up | [STREAMING-CARRIER-PLAN.md](STREAMING-CARRIER-PLAN.md#streaming-carrier-plan) |
...
| Carrier backend interface, `ArrayCarrier`, and chunk size | [stego/carrier.py](../stego/carrier.py) |
...
| PNG adapter, whole-file WAV helpers, and streamed `WavCarrier` | [stego/media.py](../stego/media.py) |
