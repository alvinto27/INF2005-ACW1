...
- [Hashing and Integrity Design Notes](HASHING-INTEGRITY-DESIGN.md) — reasoning, limits, alternatives, and the current candidate for hashing around an embedded packet.
