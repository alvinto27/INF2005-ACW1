...
- [Revised Hashing, Integrity, and Key Trust Design](Hashing_and_Integrity_Design_Revised.md) — the current three-region protocol, key-trust workflow, and start-magic discovery design.
