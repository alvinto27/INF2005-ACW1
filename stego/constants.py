...
IMAGE_MEDIA_CODE = 1
AUDIO_MEDIA_CODE = 2
VIDEO_FRAME_MEDIA_CODE = 3
VIDEO_AUDIO_MEDIA_CODE = 4
SUPPORTED_MEDIA_CODES = (IMAGE_MEDIA_CODE, AUDIO_MEDIA_CODE, VIDEO_FRAME_MEDIA_CODE, VIDEO_AUDIO_MEDIA_CODE)
MEDIA_PREFIXES = {
    IMAGE_MEDIA_CODE: "IMG",
    AUDIO_MEDIA_CODE: "AUD",
    VIDEO_FRAME_MEDIA_CODE: "VFR",
    VIDEO_AUDIO_MEDIA_CODE: "VAU",
}
