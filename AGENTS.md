...
This repository provides a signed LSB steganography protocol for strict RGB PNG and uncompressed PCM WAV carriers. Read the [Agent Navigation Map](docs/AGENT_MAP.md) and [documentation index](docs/README.md) before changing files.
...
- `stego_v1.py` requires Python 3.10+ and uses `cryptography`, NumPy, and Pillow.
